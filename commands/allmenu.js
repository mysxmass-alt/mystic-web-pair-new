...
async function allMenu(sock, from, msg, session, commands) {
    ...
    const categories = {
        ...
        '🎌 ANIME HUB': ['anime', 'manga', 'animeschedule', 'waifu', 'neko', 'megumin', 'shinobu', 'naruto', 'onepiece', 'sasuke', 'itachi', 'nezuko', 'boruto', 'mikasa', 'akiyama', 'asuna', 'erza', 'cry', 'kill', 'hug', 'pat', 'lick', 'kiss', 'bite', 'yeet', 'bully', 'bonk', 'wink', 'poke', 'nom', 'slap', 'smile', 'wave', 'awoo', 'blush', 'smug', 'glomp', 'happy', 'dance', 'cringe', 'cuddle', 'highfive', 'handhold'],
