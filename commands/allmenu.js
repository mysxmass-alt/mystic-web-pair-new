...
async function allMenu(sock, from, msg, session, commands) {
    ...
    // ===== CATEGORIES =====
    const categories = {
        '👑 OWNER': ['public', 'private', 'mode', 'owner', 'setname', 'block', 'unblock', 'bcgc', 'bcall', 'restart', 'shutdown', 'xrestart', 'xshutdown', 'nuke', 'clear', 'backup', 'restore', 'clone', 'ghostmode', 'deleteall', 'autostatus'],
        ...
        '🎌 ANIME HUB': ['anime', 'manga', 'waifu', 'neko', 'hug', 'kiss', 'bite', 'pat', 'dance', 'wave', 'highfive', 'smile', 'wink', 'happy', 'cry', 'bonk', 'yeet', 'blush', 'smug', 'slap'],
        ...
        '🏢 LOGO MAKER': ['neon', 'glitch', 'gold', '3dtext', 'fire', 'water', 'galaxy', 'marvel', 'gradient', 'luxury', 'royal', 'metal', 'chrome'],
